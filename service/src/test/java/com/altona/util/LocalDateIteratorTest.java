...
class LocalDateIteratorTest {
    ...
    public void testInvalid() {
        assertThrows(IllegalArgumentException.class, () -> LocalDateIterator.inclusive(LocalDate.of(2018, 1, 1), LocalDate.of(2017, 1, 1)).iterator());
    }

    @Test
    public void testInclusive() {
        Iterable<LocalDate> iterable = LocalDateIterator.inclusive(LocalDate.of(2018, 1, 1), LocalDate.of(2018, 1, 3));
